...
import com.example.permission.rom.HuaweiUtils;
import com.example.permission.rom.MeizuUtils;
import com.example.permission.rom.MiuiUtils;
import com.example.permission.rom.QikuUtils;
import com.example.permission.rom.RomUtils;
...
public class FloatWindowManager {
   ...
   /* public void askPermission(Context context) {
    ...
    public Dialog showAsTypeToast(View view){
        ...
        Context context1  =   activity == null ? context : activity;

        if (checkPermission(context1)) {
